---
name: improve-system
description: Analyze recent session activity and update Internal OS to reflect learnings, iterations, and improvements. Also the quality gate for creating new skills and the protocol for capturing ACT NOW items at session close.
...
2. Read `knowledge/references.md` — if a sibling repo already covers it, file a one-line pointer, do not duplicate
